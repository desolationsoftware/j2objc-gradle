...
This plugin has already published to gradle plugins, see [plugin page](https://plugins.gradle.org/plugin/net.socialhub.j2objccontrib.j2objcgradle). And more changes in [CHANGELOG](CHANGELOG.md).
...
plugins {
    id 'java'
    id "org.sarsoft.j2objccontrib.j2objcgradle" version "0.8.0"
}
